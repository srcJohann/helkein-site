...
urlpatterns = [
    ...
    path('aula/<int:lesson_id>/concluir/', views.mark_lesson_completed, name='mark_lesson_completed'),
    ...
    path('pagamento/cancelar-assinatura/', views_payment.cancel_subscription, name='cancel_subscription'),
